import { pt as __export, vt as definePreviewAddon10 } from "./blocks-CiTTNCBk.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-g1pO7oAX.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-Dln7G85z.js");
